...
const TAB_LABEL_MAP: Record<RunDetailTabKey, string> = {
  debate: '토론 로그',
  scenario: '시나리오',
  artifacts: '생성물',
  logs: '로그'
...
export default function RunDetailPage({ dataMode }: RunDetailPageProps) {
  ...
  const [selectedTab, setSelectedTab] = useState<RunDetailTabKey>('debate');
    ...
    <div className="run-detail-page">
      ...
      <div className="run-detail-layout">
        <button
          ...
          onClick={() => setIsMobileSummaryOpen((currentValue) => !currentValue)}
        >
